...
<div class="wrap">
  ...
  <section id="t-models" class="panel" hidden>
    ...
    <div class="card">
      <h2>How the suffixes work</h2>
      <p class="hint" style="margin-top:0">Pick the model id that matches what you want — the suffix toggles Baidu's modes:</p>
      <div class="kv">
        <div class="k"><span class="tag">ernie-noauth</span></div><div class="hint">fast direct answer (default)</div>
        <div class="k"><span class="tag">ernie-noauth-think</span></div><div class="hint">deep reasoning (emits thinking)</div>
        <div class="k"><span class="tag">ernie-noauth-search</span></div><div class="hint">live web search grounding</div>
        <div class="k"><span class="tag">ernie-noauth-think-search</span></div><div class="hint">reasoning + web search together</div>
      </div>
    </div>
  </section>
...
var MODELS_ABILITY={'ernie-noauth':[],'ernie-noauth-think':['t'],'ernie-noauth-search':['s'],'ernie-noauth-think-search':['t','s']};
function renderModels(ids){
  ...
  grid.innerHTML=ids.map(function(id){
    var ab=MODELS_ABILITY[id]||[]; var bz='';
    if(ab.indexOf('t')>=0) bz+='<span class="ab ab-t">🧠 think</span>';
    if(ab.indexOf('s')>=0) bz+='<span class="ab ab-s">🌐 search</span>';
