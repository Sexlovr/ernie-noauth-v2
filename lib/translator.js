...
// Models advertised on /v1/models + the dashboard. (`ernie-noauth*` still RESOLVES
// to smartMode for back-compat, but is no longer advertised.)
export const MODELS = [
  'baidu-smart', 'baidu-smart-think', 'baidu-smart-search', 'baidu-smart-research',
